...
<p align="center">
  <img src="docs/diagrams/taktology-v0.4.0.png" alt="taktology v0.4.0 — minimal core ontology graph" width="720">
</p>
...
Both files **parse cleanly** as Turtle (rdflib 7.6, v0.4.0): `takt.ttl` = 138 triples,
`takt-flowline-demo-b5-1.ttl` = 47 triples. A consistency check confirms the A-Box uses **only**
terms the T-Box defines (all 18), and every term carries a `dcterms:source`. What is
